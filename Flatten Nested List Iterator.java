/*
	...
	Logic: 1. Use stack to store the latest iterator and when iterator reaches to end, remove that iterator from the stack,
		   2. If the element is integer then return that element.
*/
/**
